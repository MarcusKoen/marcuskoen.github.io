...
This will serve as complimentary material to the cracking tuts.
Everything is in NASM, Will look at other archs.
# Hello world
```
extern MessageBoxA
extern ExitProcess
...
section .data
    ...
    cap db 'x64 Assembly', 0

section .text
    global main
main:
    sub rsp, 28h      ; Shadow space for x64 calling convention
